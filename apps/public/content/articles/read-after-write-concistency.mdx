...
**Measure everything.** Without metrics, you're guessing. Track your primary/replica distribution to make sure you're not overloading the primary.

If you're looking for an analytics platform that takes data consistency seriously, check out [OpenPanel](https://openpanel.dev).
