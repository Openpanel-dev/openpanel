...
This is a buyer's comparison, not a survey. Looking for a broader survey of the open-source analytics space — including cloud-hosted options and the difference between AGPL, MIT, and source-available licensing? See our [open source analytics tools survey](/articles/open-source-web-analytics).
