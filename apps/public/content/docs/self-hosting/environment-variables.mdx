...
### MIXPANEL_DATA_RESIDENCY

**Type**: `string`  
**Required**: No  
**Default**: `us`

Mixpanel data center to use when importing data. Set this if your Mixpanel project is hosted in the EU or India data center.
