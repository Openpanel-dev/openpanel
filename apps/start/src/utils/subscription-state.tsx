import type { SubscriptionState } from '@openpanel/db/src/subscription-state';
import { format } from 'date-fns';

type BadgeVariant = 'default' | 'secondary' | 'success' | 'warning' | 'destructive';
type Tone = 'default' | 'warning' | 'destructive';

type SubscriptionStateMeta = {
  ...
  banner: { title: string; description: string; cta: string; tone: Tone } | null;
...
const fmt = (date: Date | null | undefined) => (date ? format(date, 'PPP') : null);
