    ...
    >
      <a className="row items-center gap-2" href="https://openpanel.dev">
        ...
        <span className="font-medium text-muted-foreground text-sm">
          {isSelfHosted ? t('auth.self_hosted_analytics') : 'OpenPanel.dev'}
        </span>
      </a>
      {isSelfHosted && (
      ...
      <div className="row items-center gap-1">
        <LanguageToggle className="size-9 rounded-md text-muted-foreground hover:bg-accent hover:text-accent-foreground" />
